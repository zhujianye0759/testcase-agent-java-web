...
- [x] 3.1 从提交后的 Java Hotfix 工作树安全替换唯一 5173 前端，不修改 8082、KEE 或业务任务。 `[Req-ID]: REQ-STD-001~003`
- [x] 3.2 在 1440x820 和相关窄宽打开同一任务，验证真实 structured 状态、阶段计数、4 条发现、1 条核对、0 用例说明和下载入口，并保存截图。 `[Req-ID]: REQ-STD-001, REQ-STD-002`
