...
public enum StructuredSkillErrorType {
    INVALID_REQUEST("invalid_request"), REQUEST_TOO_LARGE("request_too_large"), SESSION_NOT_FOUND("session_not_found"), FORBIDDEN("forbidden"), UNSUPPORTED_SKILL("unsupported_skill"), SKILL_UNAVAILABLE("skill_unavailable"), MODEL_UNAVAILABLE("model_unavailable"), MODEL_EXECUTION_FAILED("model_execution_failed"), STRUCTURED_OUTPUT_INVALID("structured_output_invalid"), RESPONSE_TOO_LARGE("response_too_large");
